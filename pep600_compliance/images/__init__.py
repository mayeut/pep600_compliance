...
IMAGE_LIST = ALT_LIST + AMAZONLINUX_LIST + ARCHLINUX_LIST + CENTOS_LIST + CLEARLINUX_LIST + CLEFOS_LIST + DEBIAN_LIST + FEDORA_LIST + MAGEIA_LIST + OPENSUSE_LIST + ORACLELINUX_LIST + PHOTON_LIST + RHUBI_LIST + SLACKWARE_LIST + UBUNTU_LIST
