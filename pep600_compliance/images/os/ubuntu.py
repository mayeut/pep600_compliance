...
UBUNTU_LIST = [
    Ubuntu('ubuntu:20.04', machines=['x86_64', 'aarch64', 's390x', 'armv7l'], packages=[['python3-pip'] + UBUNTU_PACKAGES]),  # TODO 'i686', 'ppc64le'
    Ubuntu('ubuntu:19.10', machines=['i686', 'x86_64', 'aarch64', 's390x', 'armv7l'], packages=[['python3-pip'] + UBUNTU_PACKAGES]),  # TODO 'ppc64le'
    ...
    Ubuntu('ubuntu:16.10', machines=['i686', 'x86_64', 'aarch64', 's390x'], packages=[['python3-pip'] + UBUNTU_PACKAGES], apt_sources_update=UBUNTU_APT_OLD),
