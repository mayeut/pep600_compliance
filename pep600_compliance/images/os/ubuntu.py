...
UBUNTU_LIST = [
    Ubuntu('ubuntu:20.04', machines=['x86_64', 'aarch64', 'ppc64le', 's390x', 'armv7'], packages=[['python3-pip'] + UBUNTU_PACKAGES]),
    Ubuntu('ubuntu:19.10', machines=['i686', 'x86_64', 'aarch64', 'ppc64le', 's390x', 'armv7'], packages=[['python3-pip'] + UBUNTU_PACKAGES]),
    ...
    Ubuntu('ubuntu:16.10', machines=['i686', 'x86_64'], packages=[['python3-pip'] + UBUNTU_PACKAGES], apt_sources_update=UBUNTU_APT_OLD),
    ...
    Ubuntu('ubuntu:12.04', machines=['i686', 'x86_64'], packages=[['python3.5', 'curl'] + UBUNTU_PACKAGES], python='python3.5', ppa_list=UBUNTU_PYTHON_PPA),
]
