...
UBUNTU_LIST = [
    ...
    Ubuntu('ubuntu:21.04', ('EOL:2022-01-31',), machines=['x86_64', 'aarch64', 'ppc64le', 's390x', 'armv7l'], packages=[['python3-pip'] + UBUNTU_PACKAGES]),
    ...
    Ubuntu('ubuntu:17.04', ('EOL:2018-01-13',), machines=['i686', 'x86_64', 'aarch64', 'ppc64le', 's390x', 'armv7l'], packages=[['python3-pip'] + UBUNTU_PACKAGES], apt_sources_update=UBUNTU_APT_OLD),
    Ubuntu('ubuntu:16.10', ('EOL:2017-07-20',), machines=['i686', 'x86_64', 'aarch64', 'ppc64le', 's390x', 'armv7l'], packages=[['python3-pip'] + UBUNTU_PACKAGES], apt_sources_update=UBUNTU_APT_OLD),
    Ubuntu('ubuntu:16.04', ('EOL:2021-04-30', 'ELTS:2024-04-30',), machines=['i686', 'x86_64', 'aarch64', 'ppc64le', 's390x', 'armv7l'], packages=[['python3-pip'] + UBUNTU_PACKAGES]),
    Ubuntu('ubuntu:15.10', ('EOL:2016-07-28',), machines=['i686', 'x86_64'], packages=[['python3-pip'] + UBUNTU_PACKAGES], apt_sources_update=UBUNTU_APT_OLD),
    Ubuntu('ubuntu:15.04', ('EOL:2016-02-04',), machines=['i686', 'x86_64'], packages=[['python3-pip'] + UBUNTU_PACKAGES], apt_sources_update=UBUNTU_APT_OLD),
    Ubuntu('ubuntu:14.10', ('EOL:2015-07-23',), machines=['x86_64'], packages=[['python3-pip'] + UBUNTU_PACKAGES], apt_sources_update=UBUNTU_APT_OLD),
    Ubuntu('ubuntu:14.04', ('EOL:2019-04-25', 'ELTS:2022-04-30',), machines=['i686', 'x86_64', 'aarch64', 'ppc64le', 'armv7l'], packages=[['python3-pip'] + UBUNTU_PACKAGES]),
