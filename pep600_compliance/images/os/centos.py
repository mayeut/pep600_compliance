...
CENTOS_LIST = [
    ...
    CentOS('centos:7', machines=['i686', 'x86_64', 'aarch64', 'ppc64le'], pkg_manager=package_manager.YUM(), packages=[['python3-pip', 'libstdc++', 'glib2', 'libX11', 'libXext', 'libXrender', 'mesa-libGL', 'libICE', 'libSM']]),
