...
OPENSUSE_LIST = [
    ...
    OpenSUSE('opensuse/leap:15.2', ('EOL:2021-12-31',), machines=['x86_64', 'aarch64', 'armv7l'], packages=[OPENSUSE_PACKAGES]),
    OpenSUSE('opensuse/leap:15.1', ('EOL:2020-11-30',), machines=['x86_64', 'aarch64', 'armv7l'], packages=[OPENSUSE_PACKAGES]),
