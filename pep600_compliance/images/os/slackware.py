...
class Slackware(base.Base):
    def __init__(self, image, eol, pkg_manager, packages, python='python'):
        ...
        super().__init__(image, 'slackware', version, eol, pkg_manager, ['x86_64'], python=python)
...
SLACKWARE_LIST = [
    Slackware('vbatts/slackware:current', 'rolling', pkg_manager=package_manager.SLACKPKG(True), packages=[['aaa_glibc-solibs', 'python2', 'python3', 'cxxlibs', 'libX11', 'libXext', 'libXrender', 'mesa', 'libICE', 'libSM', 'libglvnd']], python='python3'),
