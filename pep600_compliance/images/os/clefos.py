...
CLEFOS_LIST = [
    ClefOS('clefos:7', ('EOL:2024-06-30',), machines=['s390x'], pkg_manager=package_manager.YUM(), packages=[['which', 'python', 'python3-pip', 'libstdc++', 'glib2', 'libX11', 'libXext', 'libXrender', 'mesa-libGL', 'libICE', 'libSM']]),
]
