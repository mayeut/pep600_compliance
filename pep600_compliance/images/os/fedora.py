...
FEDORA_LIST = [
    ...
    Fedora('fedora:27', ('EOL:2018-11-30',), machines=['x86_64', 'aarch64', 'ppc64le'], pkg_manager=DNF(), packages=[FEDORA_PACKAGES]),  # TODO 'armv7l'
    Fedora('fedora:26', ('EOL:2018-05-29',), machines=['x86_64', 'aarch64', 'ppc64le'], pkg_manager=DNF(), packages=[FEDORA_PACKAGES]),  # TODO 'armv7l'
    Fedora('fedora:25', ('EOL:2017-12-12',), machines=['x86_64'], pkg_manager=DNF(), packages=[FEDORA_PACKAGES]),  # TODO 'armv7l'
    Fedora('fedora:24', ('EOL:2017-08-08',), machines=['x86_64'], pkg_manager=DNF(), packages=[FEDORA_PACKAGES]),
    Fedora('fedora:23', ('EOL:2016-12-20',), machines=['x86_64'], pkg_manager=DNF(), packages=[FEDORA_PACKAGES]),
    Fedora('fedora:22', ('EOL:2016-07-19',), machines=['x86_64'], pkg_manager=DNF(), packages=[FEDORA_PACKAGES]),
    Fedora('fedora:21', ('EOL:2015-12-01',), machines=['x86_64'], pkg_manager=YUM(), packages=[FEDORA_PACKAGES]),
    Fedora('fedora:20', ('EOL:2015-06-23',), machines=['x86_64'], pkg_manager=YUM(), packages=[FEDORA_PACKAGES]),
]
